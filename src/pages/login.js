...
const StudentInfoAbi = [
    "function registerStudent(string, string, string, string)",
    "function getStudentInfoByStudentID(string) view returns (string, string, string, string, address)",
    "function getStudentInfo() view returns (string, string, string, string, address)"
];
